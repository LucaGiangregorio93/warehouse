...
cap program drop eigt_verify
	program eigt_verify, nclass 
		...
		else qui log using "`source'/`country'/verification_logfile.txt", text replace
		display ""
		display ""
	...
	// valuecr() can be empty, "exemption" or a positive number
	 ...
	 // Construct the file path
		...
		else local filepath "`source'/`country'/$name.xlsx"
	...
	// Define labels 
		...
		else save "`source'/`country'/data_longformat.dta", replace
		}
		display ""
