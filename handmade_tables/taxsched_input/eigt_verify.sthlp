...
{p 4 4 2}
{bf:eigt_verify} ...  describe here the adjustment    {break}
...
{p 4 4 2}
{it:source_name} depends on the source of the data and can be: 

{p 4 4 2}
	. "EY_EIG_Guide" for Worldwide Estate and Inheritance Tax Guide. 
	The program will import the excel file called "__EYb_Country__" plus the country name from the folder "EY_EIG_Guide/Country", and save there {bf:verification_logfile.txt} and {bf:data_longformat.dta}.    {break}
	
{p 4 4 2}
	. "EY_Personal_Tax_Guide" for Worldwide Personal Tax and Immigration Guide.
	The program will import the excel file called "__EYa_Country__" plus the country name from the folder "EY_Personal_Tax_Guide/Country", and save there "__verification_logfile.txt__" and "__data_longformat.dta__".    {break}
	
{p 4 4 2}
	. "Government_legislation" for national legislation.
	The program will import the excel file called "__Lex_Country__" plus the country name from the folder "Government_legislation/Country", and save there "__verification_logfile.txt__" and "__data_longformat.dta__".    {break}
...
{p 4 4 2}
{it:country_name} should have the first capital letter and coincide with the name of the folder from which the data should be uploaded.    {break}
...
{p 4 4 2}
This version: 4 December 2024    {break}
